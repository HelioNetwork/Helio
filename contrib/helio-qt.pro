...
RESOURCES += src/qt/helio.qrc src/qt/helio_locale.qrc

TRANSLATIONS += src/qt/locale/helio_bg.ts \
                src/qt/locale/helio_de.ts \
                src/qt/locale/helio_en.ts \
                src/qt/locale/helio_es.ts \
                src/qt/locale/helio_fi.ts \
                src/qt/locale/helio_fr.ts \
                src/qt/locale/helio_it.ts \
                src/qt/locale/helio_ja.ts \
                src/qt/locale/helio_pl.ts \
                src/qt/locale/helio_pt.ts \
                src/qt/locale/helio_ru.ts \
                src/qt/locale/helio_sk.ts \
                src/qt/locale/helio_sv.ts \
                src/qt/locale/helio_vi.ts \
                src/qt/locale/helio_zh_CN.ts \
                src/qt/locale/helio_zh_TW.ts
