...
Provides utilities for managing copyright headers of `The Helio_Coin
...
Helio_Coin-Project/Helio_Coin repository.
...
Setup
---------
Configuring the github-merge tool for the Helio_Coin repository is done in the following way:

    git config githubmerge.repository Helio_Coin-Project/Helio_Coin
...
A script to optimize png files in the Helio_Coin
...
If there are 'unsupported' symbols, the return value will be 1 a list like this will be printed:
    ...
    .../64/test_helio: symbol memcpy from unsupported version GLIBC_2.14
    .../64/test_helio: symbol __fdelt_chk from unsupported version GLIBC_2.15
    .../64/test_helio: symbol std::out_of_range::~out_of_range() from unsupported version GLIBCXX_3.4.15
    .../64/test_helio: symbol _ZNSt8__detail15_List_nod from unsupported version GLIBCXX_3.4.15
