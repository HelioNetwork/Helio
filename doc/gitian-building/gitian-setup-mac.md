...
The build script we'll be using is contained in the Helio_Coin github repository ([contrib/gitian-build.py](https://github.com/helio-project/helio/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the Helio_Coin repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/Helio_Coin-Project/Helio_Coin/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, helio-detached-sigs, and helio GitHub repos.
