...
The script [extract-osx-sdk.sh](https://github.com/helio-project/helio/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
helio/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/helio-project/helio/blob/master/doc/README_osx.md) for troubleshooting tips.
