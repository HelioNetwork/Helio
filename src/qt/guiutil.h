...
/** Utility functions used by the Helio_Coin Qt UI.
 */
namespace GUIUtil
{
...
// Render Helio_Coin addresses in monospace font
...
// Parse "helio:" URI into recipient object, return true on successful parsing
