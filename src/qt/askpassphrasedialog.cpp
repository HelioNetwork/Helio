...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            Helio_CoinGUI* window = static_cast<Helio_CoinGUI*>(parentWidget());
...
{
    Helio_CoinGUI* gui = static_cast<Helio_CoinGUI*>(parentWidget());
...
{
    hide();
    static_cast<Helio_CoinGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("Helio_Coin will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your HLOs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
