...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, Helio_CoinGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, Helio_CoinGUI* gui, double posX = 3);
