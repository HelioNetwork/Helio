...
#include "qt/helio/topbar.h"
#include "qt/helio/forms/ui_topbar.h"
#include "qt/helio/lockunlock.h"
#include "qt/helio/qtutils.h"
#include "qt/helio/receivedialog.h"
#include "qt/helio/loadingdialog.h"
...
TopBar::TopBar(Helio_CoinGUI* _mainWindow, QWidget *parent) :
    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopHlo}, "amount-small-topbar");
    setCssProperty({ui->labelAmountHlo}, "amount-topbar");
    setCssProperty({ui->labelPendingHlo, ui->labelImmatureHlo}, "amount-small-topbar");
...
void TopBar::loadWalletModel()
{
    ...
    // update the display unit, to not use the default ("Helio_Coin")
    updateDisplayUnit();
                            ...
                            const CAmount& delegatedBalance, const CAmount& coldStakedBalance)
{
    ...
    // HLO Total
    QString totalHlo = GUIUtil::formatBalance(balance, nDisplayUnit);

    // HLO
    // Top
    ui->labelAmountTopHlo->setText(totalHlo);
    // Expanded
    ui->labelAmountHlo->setText(totalHlo);
    ui->labelPendingHlo->setText(GUIUtil::formatBalance(unconfirmedBalance, nDisplayUnit));
    ui->labelImmatureHlo->setText(GUIUtil::formatBalance(immatureBalance, nDisplayUnit));
}
