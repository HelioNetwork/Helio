...
#include "qt/helio/settings/settingsnetworkwidget.h"
#include "qt/helio/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/helio/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(Helio_CoinGUI* _window, QWidget *parent) :
