...
#include "qt/helio/settings/forms/ui_settingswidget.h"
...
SettingsWidget::SettingsWidget(Helio_CoinGUI* parent) :
    PWidget(parent),
    ui(new Ui::SettingsWidget)
{
    ...
    connect(ui->pushButtonHelp1, &QPushButton::clicked, window, &Helio_CoinGUI::openFAQ);
