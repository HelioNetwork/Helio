...
#include "qt/helio/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/helio/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(Helio_CoinGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to Helio_CoinGUI::handleRestart()
