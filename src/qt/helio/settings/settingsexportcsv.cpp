...
#include "qt/helio/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(Helio_CoinGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("Helio_Coin_tx_csv_export(*.csv)") : tr("Helio_Coin_addresses_csv_export(*.csv)"),
                                        nullptr);
