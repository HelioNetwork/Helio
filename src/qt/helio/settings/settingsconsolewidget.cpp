...
#include "qt/helio/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/helio/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(Helio_CoinGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Helio Coin RPC console.") + "<br>" +
