...
#include "qt/helio/sendcustomfeedialog.h"
#include "qt/helio/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(Helio_CoinGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &Helio_CoinGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
