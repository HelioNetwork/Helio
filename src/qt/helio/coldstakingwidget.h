...
#include "qt/helio/furabstractlistitemdelegate.h"
#include "qt/helio/txviewholder.h"
#include "qt/helio/tooltipmenu.h"
#include "qt/helio/sendmultirow.h"
#include "qt/helio/coldstakingmodel.h"
#include "qt/helio/contactsdropdown.h"
...
public:
    explicit ColdStakingWidget(Helio_CoinGUI* parent);
    ~ColdStakingWidget();
