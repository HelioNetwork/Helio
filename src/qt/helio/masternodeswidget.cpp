...
#include "qt/helio/forms/ui_masternodeswidget.h"

#include "qt/helio/qtutils.h"
#include "qt/helio/mnrow.h"
#include "qt/helio/mninfodialog.h"
#include "qt/helio/masternodewizarddialog.h"
...
MasterNodesWidget::MasterNodesWidget(Helio_CoinGUI *parent) :
    PWidget(parent),
    ...
    if (fs::exists(pathBootstrap)) {
        ...
        if (lineCopy.size() == 0) {
            lineCopy = "# Masternode config file\n"
                                    ...
                                    "# Example: mn1 127.0.0.2:14920 93HaYBVUCYjEMeeH1Y4sBGLALQZE1Yc1K64xiqgX37tGBDQL8Xg 2bcd3c84c84f87eaa86e4e56834c92927a07f9e18718810b92e0d0324456a67c 0\n";
        }
