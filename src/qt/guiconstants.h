...
/* Helio GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Helio_Coin"
#define QAPP_ORG_DOMAIN "helio.org"
#define QAPP_APP_NAME_DEFAULT "Helio_Coin-Qt"
#define QAPP_APP_NAME_TESTNET "Helio_Coin-Qt-testnet"
