...
//
// The Masternode Class. It contains the input of the 10000 HLO, signature to prove
...
public:
    ...
    /// Is the input associated with collateral public key? (and there is 10000 HLO - checking if valid masternode)
