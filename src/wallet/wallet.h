...
enum WalletFeature {
    ...
    FEATURE_PRE_Helio_Coin = 61000, // inherited version..
...
public:
    ...
    static const CAmount DEFAULT_STAKE_SPLIT_THRESHOLD = 50 * COIN;
    ...
    /// Get 10000 HLO output and keys which can be used for the Masternode
