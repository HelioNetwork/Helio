...
UniValue stop(const JSONRPCRequest& jsonRequest)
{
    ...
    if (jsonRequest.fHelp || jsonRequest.params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop Helio_Coin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "Helio_Coin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Helio_Coin features */
        {"helio", "listmasternodes", &listmasternodes, true },
        {"helio", "getmasternodecount", &getmasternodecount, true },
        {"helio", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"helio", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"helio", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"helio", "masternodecurrent", &masternodecurrent, true },
        {"helio", "startmasternode", &startmasternode, true },
        {"helio", "createmasternodekey", &createmasternodekey, true },
        {"helio", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"helio", "listmasternodeconf", &listmasternodeconf, true },
        {"helio", "getmasternodestatus", &getmasternodestatus, true },
        {"helio", "getmasternodewinners", &getmasternodewinners, true },
        {"helio", "getmasternodescores", &getmasternodescores, true },
        {"helio", "preparebudget", &preparebudget, true },
        {"helio", "submitbudget", &submitbudget, true },
        {"helio", "mnbudgetvote", &mnbudgetvote, true },
        {"helio", "getbudgetvotes", &getbudgetvotes, true },
        {"helio", "getnextsuperblock", &getnextsuperblock, true },
        {"helio", "getbudgetprojection", &getbudgetprojection, true },
        {"helio", "getbudgetinfo", &getbudgetinfo, true },
        {"helio", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"helio", "mnfinalbudget", &mnfinalbudget, true },
        {"helio", "checkbudgets", &checkbudgets, true },
        {"helio", "mnsync", &mnsync, true },
        {"helio", "spork", &spork, true },
...
{
    return "> helio-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:14919/\n";
}
