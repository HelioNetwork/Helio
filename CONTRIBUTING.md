Contributing to Helio Coin
============================

The Helio Coin project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/helio-project/helio/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Helio Coin project, and is not to be
confused with overall Helio_Coin Network Protocol consensus changes.

Whether a pull request is merged into Helio Coin rests with the project merge
...
Patches that change Helio_Coin consensus rules are considerably more involved than
...
Where a patchset proposes to change the Helio_Coin consensus, it must have been
...
The project leader is the release manager for each Helio Coin release.
